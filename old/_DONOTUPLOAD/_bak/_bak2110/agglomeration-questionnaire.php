...
if (isset($_POST['Submit'])) {
	...
	$sieve_analysis = isset($_POST['sieve_analysis']) ? $_POST['sieve_analysis'] : "" ;
...
Sieve Analysis of the raw material:\r
Percentage: ".$bulk_density." ".$sieve_analysis."\r\n
...
//Send the mail
	if ($vname !== false && $vcompany !== false && $vname !== false) {
		mail ("jakecortese@gmail.com", "Agglomeration Questionnaire Form Submission", $message, $headers);
...
<li><a href="overview.htm">Company Overview</a></li>
  ...
  <li><a href="http://www.levydev.com/marsmineral/agglomeration-questionnaire.html">Agglomeration RFQ</a></li>
  ...
  <li><a href="index.htm">Home</a></li>
   ...
   <img src="images/shell/pellets.jpg" alt="pellets" id="pellets"/>
   <h1>Mars Mineral</h1>
   <div id="content">

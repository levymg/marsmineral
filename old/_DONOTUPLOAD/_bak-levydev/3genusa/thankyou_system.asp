...
'Start by setting up the message itself.
	...
	call mSTDRESP_text("Third Generation Schedule Service Form Submission")
	call mSTDRESP_field("First Name", "firstname", 100)
	call mSTDRESP_field("Last Name", "lastname", 100)
	...
	call mSTDRESP_field("Describe your service issue", "describe", false)
	
	if mSTDRESP_error() = "" then
	
'Send the email.
	call mSTDRESP_email("service@3genusa.com" , "service@3genusa.com", "Third Generation Schedule Service Form Submission", mSTDRESP_msg())

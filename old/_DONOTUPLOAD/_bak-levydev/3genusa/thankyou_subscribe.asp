...
'Start by setting up the message itself.
	...
	call mSTDRESP_text("Third Generation Newsletter Subscription Form Submission")
	call mSTDRESP_field("Name", "name", 100)
	call mSTDRESP_field("Email", "email", 100)
	call mSTDRESP_field("Company", "company", 100)
	
	if mSTDRESP_error() = "" then
	
'Send the email.
	call mSTDRESP_email("mray@3genusa.com " , "mray@3genusa.com ", "Third Generation Newsletter Subscription Form Submission", mSTDRESP_msg())

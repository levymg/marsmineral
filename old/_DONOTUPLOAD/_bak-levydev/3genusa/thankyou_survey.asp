...
'Start by setting up the message itself.
	...
	call mSTDRESP_text("Third Generation Survey Form Submission")
	call mSTDRESP_field("What is the most important reason that your company might consider switching to a hosted IP Communications network?", "mostimportant", 100)
	call mSTDRESP_field("Email Address", "email", 100)
	
	if mSTDRESP_error() = "" then
	
'Send the email.
	call mSTDRESP_email("mray@3genusa.com " , "mray@3genusa.com ", "Third Generation Survey Form Submission", mSTDRESP_msg())

...
$bcc = "davelevy@levymgi.com";
$to = "greg@levymgi.com, dryhal@marsmineral.com, jpitzer@woodwardinc.com, info@marsmineral.com";
$to = "greg@levymgi.com";
$subject = "Mars Mineral Rep Inquiry Form\r\n\r\n";
$body = "The following message has been submitted through the marsmineral.com Rep form.\r\n
Name: ".$name."
Title: ".$title."
Company: ".$company."
Phone: ".$phone."
...
Country: ".$country."
Zip/Postal: ".$zip."
Territories you would like to cover: ".$comments;
...
?>
    ...
    <div class="content">
    	<div class="col-left">
            ...
            <h2>We would like to learn more about<br />your interest in representing Mars Mineral Products.</h2>
            
            <?php echo $confirmation; ?>
            
            <?php if ($displayform == true) { ?>
            
            <p>Let us know what territories you would like to represent for Mars Mineral Equipment</p>
            
            <form action="contact-reps.php" class="cmxform" method="post" style="width:430px;" id="contactform">
            ...
            <fieldset>
                <ol>
                    ...
                    <li><label for="company">Company Name </label> <input name="company" id="company" value="" type="text" /></li>
                    ...
                    <li><label for="address">Address 2</label> <input name="address" id="address" value="" type="text" /></li>
                    ...
                    <li style="margin-top:15px;"><strong>Territories you would like to cover:</strong>
					<label for="comments"> </label> <textarea name="comments" id="comments" cols="50" rows="6" style="margin-top:7px;"></textarea></li>

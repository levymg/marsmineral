...
//Send the mail
		mail ($to, "Agglomeration Questionnaire Form Submission", $message, $header);
...
<fieldset class="step">
    <ol>
        ...
        <li>
            ...
            <p style="font-weight:800;font-size:15px;">Note:  International customers must pay invoices by wire transfer.</p>
    	</li>

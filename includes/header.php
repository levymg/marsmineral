...
<div id="header">
    <a href="index.php"><img src="images/HPanim.gif" alt="Mars Mineral Logo" id="logo" /></a>
    <div id="tagline">A global leader in agitation technology &mdash;<br>the conversion of fine powders and dusts<br>into spherical pellets.</div>
                <!--<div id="tradeshow-box">
                    <center>
                    <h3>See us at:</h3>
                    </center>
                    <a href="http://ippexpo.com/" target="_blank"><img style="margin-top:0px;margin-left:23px;" src="images/carbon-black.png" alt="Carbon Black Mineral Trade Show" style="float:right;" /></a>
                </div> -->
</div>

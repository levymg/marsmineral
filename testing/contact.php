...
$message = "Mars Mineral Contact Form Submission\r
Name: ".$name."
Title: ".$title."
Company: ".$company."
Phone: ".$phone."
...
if ($vname !== false && $vemail !== false) {
	mail ("jake@levymgi.com", "Mars Mineral Contact Form", $message, $headers);
	mail ("info@marsmineral.com", "Mars Mineral Contact Form", $message, $headers);
	$confirmation = "<h2>Thank you. We will respond shortly.</h2>";
	$displayform = false;
} else {
    ...
    <div class="content">
    	<div class="col-left">
            ...
            <fieldset>
                <ol>
                    ...
                    <li><label for="name">Company Name<em>*</em> </label> <input name="company" id="company" value="" type="text" /></li>
        ...
        <div class="col-right">
            ...
            <div class="contactbox">
                ...
                P.O. Box 719<br>
                Mars, PA 16046<br><br />
                Phone: 724-538-3000<br>
                Fax: 724-538-5078<br />
                <a href="mailto:info@marsmineral.com">info@marsmineral.com</a>
            </div>

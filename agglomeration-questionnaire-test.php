...
for($i=0; $i<count($_FILES['msds']['name']); $i++) {
	...
	mail("davelevy@levymgi.com", $subject, "", $header);
...
//Send the mail
		//mail ("ctaylor@marsmineral.com, bhinkle@marsmineral.com, dryhal@marsmineral.com, jpitzer@woodwardinc.com", "Agglomeration Questionnaire Form Submission", $message, $header);
...
<form action="agglomeration-questionnaire-test.php" method="post" enctype="multipart/form-data" class="cmxform" id="aggform">
<div id="results"></div>

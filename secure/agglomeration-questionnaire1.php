...
if (isset($_POST['Submit'])) {
	...
	$binderdet = isset($_POST['binderdet']) ? $_POST['binderdet'] : "" ;
...
If the material is a mixture, what are the specific components and what are their percentages: ".$mixture."\r\n
...
Do you require a nondisclosure agreement?: ".$nda."\r\n
...
".$waterbindertext."\r\n
Do you have a preference of binder choice or knowledge of materials that could be detrimental to your pelletized product?
".$binderdet."\r\n
...
$to = "ctaylor@marsmineral.com, bhinkle@marsmineral.com, dryhal@marsmineral.com, jpitzer@woodwardinc.com";
$tolevy = "jake@levymgi.com, davelevy@levymgi.com";
...
$header .= "--$uid--\r\n";
	...
	send($tolevy, $subject, $message, $from, $file, $type);
...
//Send the mail
	if ($vname !== false/* && $vcompany !== false && $vemail !== false && $vcity !== false && $vstate !== false && $vcountry !== false && $vphone !== false && $vtest_type !== false && $vpo_number !== false && $vreturn_address !== false && $vpreferred_shipping !== false && $vmaterial !== false && $vmixture !== false && $vhazardour !== false && $vconsistency !== false && $vproduct_desired !== false && $vspecial_conditions !== false && $vbinder !== false && $vproduction_capacity !== false && $viagree !== false*/) {
		...
		mail ("dryhal@marsmineral.com", "Agglomeration Questionnaire Form Submission", $message, $header);
		mail ("dave@levymgi.com", "Agglomeration Questionnaire Form Submission", $message, $header);
...
<p>Complete the form below to help us understand how we may help you achieve your pelletization objectives.</p>
...
<fieldset class="step">
    <ol>
        ...
        <li><label for="phone" class="required">Phone<em>*</em></label><input name="phone" type="text" /></li>
    ...
    <ol id="shippingaddressol">
    	...
    	<li><label for="attn" class="required">Attention</label><input name="attn" type="text" /></li>
        <li><label for="saddress" class="required">Address<em>*</em></label><input name="address" type="text" /></li>
        <li><label for="saddress2">Address 2</label><input name="address2" type="text" /></li>
        <li><label for="scity" class="required">City<em>*</em></label><input name="city" type="text" /></li>
        <li><label for="sstate" class="required">State<em>*</em></label>
            <select name="state" class="input" id="state">
            <option value="" selected="selected">Select state/province</option>
            <option value="AL">Alabama</option>
            <option value="AK">Alaska</option>
        ...
        <li><label for="szip">Zip/Postal Code</label><input name="zip" type="text" /></li>
        <li><label for="scountry" class="required">Country<em>*</em></label>
            <select name="country" class="input" id="country">
            <option selected="selected">Select country</option>
            <option value="United States">United States</option>
            <option value="Afghanistan">Afghanistan</option>
    ...
    <ol>
    	<li><label for="postep">Purchase Order</label>
            <select name="postep" id="postep">
              ...
              <option value="poenter">Enter an existing PO no.</option>
              <!--<option value="poattach">Attach a PO</option>-->
              <option value="pocredit">Enter credit card information</option>
              <option value="poverbal">Verbal Only</option>
            </select>
        </li>
        <li id="po1"><label for="pono">Enter your PO no.</label><input name="pono" type="text" /></li>
        <li id="po2"><label for="filepo" class="required">Attach your PO<em>*</em></label><input type="file" name="filepo" id="filepo" /></li>
    </ol>
</fieldset>

<div id="upsfedexccholder">
<fieldset class="step">
<legend></legend>
    <ol id="upsfedexol">
...
<fieldset class="step">
    <ol>
        ...
        <li>If the material is a mixture, what are the specific components and what are their percentages:</li>
...
<fieldset class="step">
    <ol>    
        ...
        <li><label for="bulk_density" class="required">Aerated Bulk Density: pounds per cubic ft<em>*</em></label><input name="bulk_density" type="text" /></li>
        <li><label for="moisture_content" class="required">Moisture Content<em>*</em></label><input name="moisture_content" type="text" /></li>
        <li>
        <fieldset>
            <legend>Does contact with water or other common chemicals have a detrimental effect on your material?<em>*</em></legend>
            <label><input name="watercheck" value="yes" type="radio">Yes</label>
            <label><input name="watercheck" value="no" type="radio">No</label>
        </fieldset>
        </li>
        <li>If so, please explain.</li>
        <li><textarea name="waterchecktext" cols="40" rows="3"></textarea></li>
        <li>
        <fieldset>
            <legend>Are there any common environmental conditions that are detrimental to your product, such as exposure to given temperatures, etc.?<em>*</em></legend>
...
<ol>
    ...
    <li>
    <fieldset>
        <legend>Do you require a <a href="pdf/5-18-12 Standard NDA.pdf" target="_blank">nondisclosure agreement</a> before you may discuss your project with Mars Mineral?</legend>
        <label><input name="nda" value="yes" type="radio">Yes</label>
        <label><input name="nda" value="no" type="radio">No</label>
    </fieldset>
    </li>
    <li><label>Pellet diameter or mesh size<em>*</em></label><input name="targetpellet" type="text" /></li>
    <li><label>Moisture content<em>*</em></label><input name="targetmoisture" type="text" /></li>
</ol>
</fieldset>
...
<fieldset class="step">
    <ol>
        ...
        <li>What is the general end use of your pellets?  For example, will the pellets be recycled, packaged for a customer, or processed for disposal, etc.?<em>*</em></li>
        ...
        <li><textarea name="binderdet" cols="40" rows="4"></textarea></li>
        <li>What is the design production capacity in tons per hour?<em>*</em></li>
        <li><input name="production_capacity" type="text" /></li>
        <li><label for="iagree" class="required" style="width:100%;"><input name="iagree" type="checkbox" value="I Agree" /> I agree to the Terms and Conditions listed on this page.<em>*</em></label></li>
    </ol>

...
<fieldset class="step">
    ...
    <ol>
    	<li><label for="postep">Purchase Order No. <em>*</em></label>
...
<fieldset class="step">
    <ol>
        ...
        <li><label for="iagree" class="required"><input name="iagree" type="checkbox" value="I Agree" />I agree to the Terms and Conditions listed on this page.<em>*</em></label></li>
    </ol>

...
for($i=0; $i<count($_FILES['msds']['name']); $i++) {
	...
	$confirmation = "<p>Thank you for filling out our Agglomeration Questionnaire. Someone will get back to you shortly. You may <a href=\"http://www.marsmineral.com/secure/agglomeration-questionnaire.php\">fill out another form</a>, or continue browsing the website.</p>";
	$showform = false;
...
<fieldset class="step">
    ...
    <ol>
        ...
        <li>
            <select name="preferred_shipping">
            <option value="Collect" selected="selected">Collect (must provide UPS or FedEx account number)</option>
...
<fieldset class="step">
    <ol>    
        ...
        <li><label for="moisture_content">Moisture Content<em>*</em></label><input name="moisture_content" type="text" size="4" />%</li>
        <li>
        <fieldset>
